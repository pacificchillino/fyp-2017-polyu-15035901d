  ...
  //if (withLatLong) {
    ...
    return rp(options)
      .then(function(jsCode) {
        ...
        var evalTramStops = eval.call({},"'use strict'; var window; var google = {maps: {InfoWindow: function() {},event: {addDomListener: function() {}}}};" + jsCode + '; var stops = stopsArrayEB.concat(stopsArrayWB); stops');
        var tramStops = [];
